/* Console version WITH KEYBOARD SHORTCUT - Copy and paste this entire code into the browser console */
...
(function() {
  ...
  console.log("✅ Toggle case plugin loaded successfully!");
  console.log("📝 Right-click menu: 'Toggle Case (Upper/Title/Lower)'");
  console.log("⌨️ Keyboard shortcut: Ctrl+Shift+U (while focused on a block)");
  console.log("🔄 Cycles through: lowercase → UPPERCASE → Title Case → lowercase");
})();